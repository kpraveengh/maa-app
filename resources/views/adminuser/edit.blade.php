...
{{ Form::model($users, array('route' => array('adminuser.update', $users->id), 'method' => 'PUT','class'=>'form-horizontal','files'=>true)) }}
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="submit" name="submit" class="btn btn-info">Update</button>
     <a class="btn btn-small btn-primary" href="{{ URL::to('adminuser/' . $users->id) }}">Cancel</a>
  </div>
</div>
</fieldset>
